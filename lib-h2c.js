...
var __h2c_lib__ = (() => {
  ...
  // libs/entry_html2canvas.mjs
  var entry_html2canvas_exports = {};
  __export(entry_html2canvas_exports, {
    default: () => html2canvas
  });
...
\u{1F4CA} Performance Summary (Total: ${summary.totalDuration.toFixed(2)}ms):`);
  ...
  var Bounds = class Bounds2 {
    ...
    static {
      this.EMPTY = new Bounds2(0, 0, 0, 0);
    }
  };
  ...
  var Tokenizer = class Tokenizer2 {
    static {
      this._pool = [];
    }
    static {
    ...
    static get() {
      return Tokenizer2._pool.pop() || new Tokenizer2();
    }
    static release(tokenizer) {
      if (Tokenizer2._pool.length < Tokenizer2.MAX_POOL_SIZE) {
        tokenizer._reset();
        Tokenizer2._pool.push(tokenizer);
      }
    }
    constructor() {
      this._value = [];
  ...
  var CSSParsedDeclaration = class CSSParsedDeclaration2 {
    get border() {
    ...
    constructor(context, declaration) {
      const standardProps = CSSParsedDeclaration2.standardProps;
  ...
  return __toCommonJS(entry_html2canvas_exports);
})();
